...
const home = {
    ...
    subline: <>I'm Jaedon, a hands-on software engineer specialising in production agentic AI, search, and data infrastructure. I've worked across startups backed by <InlineCode style={{ color: '#b2b2b2' }}>Oxford University Innovation</InlineCode> and in the <InlineCode style={{ color: '#b2b2b2' }}>Nvidia Inception</InlineCode> program, spanning semiconductor, VC, and future-of-work SaaS.<br/><br/>Founder of <TechLink href="https://fluxsearch.io">Flux Search</TechLink>, a freshness-first semantic search engine for developers and AI agents. Previously Software Engineer at <TechLink href="https://evvolve.io" dim>Evvolve & Partners</TechLink>, VP of Partnerships at <TechLink href="https://www.chiphub.com" dim>ChipHub</TechLink>, and Analyst at <TechLink href="https://www.yasinvest.com" dim>Spartech Ventures</TechLink>.</>
}
